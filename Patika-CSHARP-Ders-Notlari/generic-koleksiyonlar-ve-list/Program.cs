...
kullanici1.Isim = "Mahmut";
kullanici1.Soyisim = "Baysağ";
kullanici1.Yas = 20;

kullanicilar kullanici2 = new kullanicilar();
kullanici2.Isim = "Necip";
kullanici2.Soyisim = "Baysağ";
kullanici2.Yas = 19;
...
YeniList.Add(new kullanicilar(){Isim="Zengin",Soyisim="Bilal",Yas=35});
